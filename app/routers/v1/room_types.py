...
async def create_room_type(
    ...
    return room_type_service.create_room_type(data)
...
async def get_room_type_by_id(
    ...
    return room_type_service._get_room_type_or_404(room_type_id)


@router.get("/all", response_model=RoomTypeResposeSchema)
async def get_all_room_types(
    room_type_service: RoomTypesService = Depends(get_room_type_service),
    skip: int = 0,
    limit: int = 100,
):
    return room_type_service.get_all(skip, limit)
...
async def update_room_type_by_id(
    ...
    return room_type_service.update_room_type(room_type_id, data)
...
async def delete_room_type_by_id(
    ...
    return room_type_service.delete_room_type(room_type_id)
...
async def delete_all_room_types(
    ...
    return room_type_service.delete_all_room_types(room_type_id)
