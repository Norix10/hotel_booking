...
class Booking(Base):
    ...
    room_id: Mapped[str] = mapped_column(ForeignKey("room.id", ondelete="CASCADE"), nullable=False)
    ...
    payment: Mapped[list["Payment"]] = relationship(back_populates="booking", cascade="all, delete-orphan")
